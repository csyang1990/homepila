...
var yDatatablesMan = function(yurl, ydiv, ytable, apara0, apara1, yy=650, yorder=false) {
    console.log("START yDatatablesMan yfdt : " + yurl + " , " + ydiv  + " , " + ytable + " , " + apara0 + " , " + apara1)
    $.ajax({
        "url": '/' + yurl,  //"url": '/Ajob',
        "dataType": "json",
        "data": {
        ...
        "success": function(json) {
            yfdtman(json, ydiv, ytable, yy, yorder);
        }
    });
}
yangtbman = ''
var yfdtman = function(json, ydivmon, ytablemon, yy=false, yorder=false) {
    console.log('Start yfdtman !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    if (json.columns.length > 0) {
        var tableHeaders = "";
        ...
        yangtbman = $('#' + ytablemon).removeAttr('width').DataTable({
            "destroy": true,
            "data": json.data,
            "scrollY": yy,
            "paging" : false,
    ...
    $("#tabs").tabs({
        activate: function( event, ui ){
            ...
            if(selectedTab == 0){
                ...
                $("#tabs").tabs({ active: 1 })
                yDatatablesmodal('ACUST', "ydiv1", "ytable1", "yModalinputcust", 700);
            } else if(selectedTab == 2){
                console.log('Clicked Tab#12 !!!');
                //$("#tabs").tabs({ active: 2 })
                //yDatatablesmodal('ACUST', "ydiv12", "ytable12", "yModalinputcust", 700);
            } else if(selectedTab == 3){
                $("#tabs").tabs({ active: 3 })
                yDatatablesmodal('APEOP', "ydiv2", "ytable2", "yModalinputpeop", 700);
            }  else if(selectedTab == 4){
                $("#tabs").tabs({ active: 4 })
                yDatatablesmodal('AREGI', "ydiv3", "ytable3", "yModalinputregi", 700);
            }  else if(selectedTab == 5){
                $("#tabs").tabs({ active: 5 })
                yDatatablesmodal('AWORK', "ydiv4", "ytable4", "yModalinputwork", 700);
                ...
                console.log('Clicked Tab#72 !!!');
                //$("#tabs").tabs({ active: 9 })
                //yDatatables('APAY', "ydiv72", "ytable72", 700, true);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#btn_query').click(function(){
        ...
        if (ymanqry.length > 1) {
            yDatatablesMan('AMAN12', 'ydiv9', 'ytable9', ymanqry, 650);
        }

    });
    $('#btn_qry12').click(function(){
        var ymanqry = $( "#qry_filter12" ).val();
        console.log("Clicked btn_query12 : " + ymanqry)
        if (ymanqry.length > 1) {
            yDatatablesMan('AMAN12', 'ydiv12', 'ytable12', ymanqry, "yang", false);
            yDatatablesMan('AMAN121', 'ydiv121', 'ytable121', ymanqry, "yang", 500);
            yDatatablesMan('AMAN122', 'ydiv122', 'ytable122', ymanqry, "yang", 500);
        } else {
            console.log('Length is 1 !!!');
        }

    });
    $('#btn_qry72').click(function(){
        var ymanqry1 = $( "#qry_filter721" ).val();
        var ymanqry2 = $( "#qry_filter722" ).val();
        console.log("Clicked btn_query721, btn_query722 : " + ymanqry1 + ' , ' + ymanqry2)
        if (ymanqry1.length > 1) {
            yDatatablesMan('AMAN72', 'ydiv72', 'ytable72', ymanqry1, ymanqry2, false);
            yDatatablesMan('AMAN721', 'ydiv721', 'ytable721', ymanqry1, ymanqry2, 500);
            yDatatablesMan('AMAN722', 'ydiv722', 'ytable722', ymanqry1, ymanqry2, 500);
        } else {
            console.log('Length is 1 !!!');
        }
